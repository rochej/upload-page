...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileView = __webpack_require__(7);
	var FileModel = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	with(obj||{}){
	__p+='<label for="id_filename">Filename</label>\n<input type="text" name="filename" id="id_filename" value="'+
	((__t=( filename ))==null?'':_.escape(__t))+
	'"/>\n<label for="id_created_at">Upload Date</label>\n<input type="text" name="created_at" id="id_created_at" value = "'+
	((__t=( created_at ))==null?'':_.escape(__t))+
	'"/>\n<label for="id_status">Status</label>\n<input type="text" name="status" id="id_status" value = "'+
